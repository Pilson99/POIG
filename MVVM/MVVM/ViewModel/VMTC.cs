...
namespace MVVM.ViewModel
{
    ...
    class VMTC : ViewModelBase
    {
        private TC PanelITC = new TC("C:\\Users");
        public VMTC() { Window_Loaded(); }
        ~VMTC() { }
        ...
        private ObservableCollection<IPath> CastToObservable(List<IPath> list, ObservableCollection<IPath> observable)
        {
